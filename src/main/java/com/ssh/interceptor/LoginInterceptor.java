...
import com.ssh.controller.LoginController;
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        LoginInfo loginSession = (LoginInfo) request.getSession().getAttribute(
                LoginInfo.USER_SESSION_KEY);
        ...
        if (loginSession == null) {
            ...
            request.getSession().setAttribute(LoginInfo.USER_SESSION_KEY,
                    loginSession);
        }
        return true;*/
    }
